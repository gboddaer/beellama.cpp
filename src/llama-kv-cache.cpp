...
llama_kv_cache::llama_kv_cache(
    ...
    // Re-declare attn_rot_disable for turbo-aware path (out of scope from else block above)
    const char * LLAMA_ATTN_ROT_DISABLE_ENV = getenv("LLAMA_ATTN_ROT_DISABLE");
    const bool attn_rot_disable = LLAMA_ATTN_ROT_DISABLE_ENV ? atoi(LLAMA_ATTN_ROT_DISABLE_ENV) : false;
